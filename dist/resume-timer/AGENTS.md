...
This repository is **resume-timer**, a macOS CLI that opens a Terminal
...
- "set up resume-timer" · "install resume-timer"
...
Alternative from a clone: `git clone https://github.com/shikhar127/resume-timer.git && cd resume-timer && ./install.sh`
...
| Different command on fire | `resume-timer in 5h --cmd "codex resume"` |
