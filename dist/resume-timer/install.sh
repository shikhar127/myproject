...
#   2. Piped from the web:  curl -fsSL https://raw.githubusercontent.com/shikhar127/resume-timer/main/install.sh | bash
#
...
RAW_BASE="${RESUME_TIMER_RAW_BASE:-https://raw.githubusercontent.com/shikhar127/resume-timer/main}"
